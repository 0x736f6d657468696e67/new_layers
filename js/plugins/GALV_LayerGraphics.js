 ...
 * ----------------------------------------------------------------------------
 *
 *   LAYER MAPID ID GRAPHIC XSPEED YSPEED OPACITY Z XSHIFT YSHIFT BLEND XCAMERA YCAMERA
 *
 ...
 * It's width would be 100px larger than the width of the screen and the layer is completely opaque and in blending mode screen
 *
 * Using Variables
 * if you put a "v" before the property. The number after will be variable id.
