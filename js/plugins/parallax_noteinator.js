...
(function () {
    ...
    Game_Map.prototype.setup = function (mapId) {
        ...
        if (parallaxMaps['special_parallax'].contains(String(mapId))) {
            switch (mapId) {
                case 127:  // SOLAR SYSTEM
                    $dataMap.note = `${$dataMap.note}\nLAYER 1 space_background_parallax 0.2 0 255 0 10 0 0 1 1\nLAYER 2 small_stars_parallax 0.3 0 255 0 15 0 0 1 1\nLAYER 3 big_stars_parallax 0.3 0 255 0 25 0 0 1 1`
                ...
                case 489:
                    $dataMap.note = `${$dataMap.note}\nLAYER 1 space_background_parallax 0.2 0 255 0 0 10 0 1 1\nLAYER 2 small_stars_parallax 0.3 0 255 0 3 20 0 1 1\nLAYER 3 big_stars_parallax 0.4 0 255 0 5 30 0 1 1`
                    $dataMap.parallaxName = '';
                    $dataMap.parallaxNameSx = 0;
                    $dataMap.parallaxNameSy = 0;
                    $dataMap.scrollType = 0;
                ...
                case 436: // BALCONY (in sweethearts' castle)
                    $dataMap.note = `${$dataMap.note}\nLAYER 1 space_background_parallax 0.2 0 255 0 0 2 0 1 1\nLAYER 2 small_stars_parallax 0.3 0 255 0 3 15 0 1 1\nLAYER 3 big_stars_parallax 0.4 0 255 0 5 20 0 1 1`
                    $dataMap.parallaxName = '';
                    $dataMap.parallaxNameSx = 0;
                    $dataMap.parallaxNameSy = 0;
                    $dataMap.scrollType = 0;
                ...
                case 466: // NEIGHBOR'S BEDROOM 
                    $dataMap.note = `${$dataMap.note}\nLAYER 1 space_background_parallax 0.1 -0.2 255 0 0 -10 0 1 1\nLAYER 2 small_stars_parallax -0.3 0 255 0 3 -15 0 1 1\nLAYER 3 big_stars_parallax 0.3 0 255 5 5 8 0 1 1`
                    $dataMap.parallaxName = '';
                    $dataMap.parallaxNameSx = 0;
                    $dataMap.parallaxNameSy = 0;
                    $dataMap.scrollType = 0;
        ...
        if (parallaxMaps['space_parallax'].contains(String(mapId))) {
            ...
            $dataMap.note = `${$dataMap.note}\nLAYER 1 space_background_parallax 0.2 0 255 0 0 0 0 1 1\nLAYER 2 small_stars_parallax 0.3 0 255 0 3 0 0 1 1\nLAYER 3 big_stars_parallax 0.4 0 255 0 5 0 0 1 1`
            $dataMap.parallaxName = '';
            $dataMap.parallaxNameSx = 0;
            $dataMap.parallaxNameSy = 0;
            $dataMap.scrollType = 0;
        ...
        if (parallaxMaps['underwater_parallax'].contains(String(mapId))) {
            $dataMap.note = `${$dataMap.note}\nLAYER 1 underwater_parallax_1 0.15 0 255 0 0 0 0 1 1\nLAYER 2 underwater_parallax_2 -0.2 0.1 255 0 3 0 0 1 1\nLAYER 3 underwater_parallax_3 0.1 0.4 255 0 6 0 0 1 1\nLAYER 4 underwater_parallax_4 0.1 0.1 255 0 4 1 3 1 1`
            $dataMap.parallaxName = '';
            $dataMap.parallaxNameSx = 0;
            $dataMap.parallaxNameSy = 0;
            $dataMap.scrollType = 0;
